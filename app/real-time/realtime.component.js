								...
								.then(function(data) {
									...
									ServicesService.GetRealTimeLogLevel('yarn')
										.then(function(data) {
											...
											generateStackedBars('linechart-services-error', [ [ 'flume' ].concat(flume[0]), [ 'zookeeper' ].concat(zookeeper[0]), [ 'yarn' ].concat(yarn[0]) ]);
											generateStackedBars('linechart-services-info', [ [ 'flume' ].concat(flume[1]), [ 'zookeeper' ].concat(zookeeper[1]), [ 'yarn' ].concat(yarn[1]) ]);
											generateStackedBars('linechart-services-warn', [ [ 'flume' ].concat(flume[2]), [ 'zookeeper' ].concat(zookeeper[2]), [ 'yarn' ].concat(yarn[2]) ]);
